...
class HomeScreen(ctk.CTkFrame):
    def __init__(self, parent, controller):
        ...
        self.logo_img = ctk.CTkImage(
            light_image=Image.open(os.path.join("frontend", "assets", "logo.png")),
            dark_image=Image.open(os.path.join("frontend", "assets", "logo.png")),
            size=(150, 150)
        )
        ...
        self.load_gif(os.path.join("frontend", "assets", "illustration.gif"))
        self.animate_gif()
